...
export const getUsers = () => {
    const promise = axios.get(`https://soup-server.herokuapp.com/auth/login`);
    return dispatch=>{
...
export const getUser = (id) => {
    const promise = axios.get(`https://soup-server.herokuapp.com/auth/login${id}`)
    return dispatch=>{
...
export const changeUser = (user, userId) => {
    const promise = axios.put(`https://soup-server.herokuapp.com/auth/login${userId}`, user)
    return dispatch=>{
...
export const deleteUser = (id) => {
    const promise = axios.delete(`https://soup-server.herokuapp.com/auth/login${id}`)
    return dispatch =>{
